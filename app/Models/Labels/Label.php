...
abstract class Label
{
     ...
     * @return float
     */
    abstract public function getMarginTop();
     ...
     * @return float
     */
    abstract public function getMarginBottom();
     ...
     * @return float
     */
    abstract public function getMarginLeft();
     ...
     * @return float
     */
    abstract public function getMarginRight();
     ...
     * @return bool
     */
    abstract public function getSupportAssetTag();
     ...
     * @return bool
     */
    abstract public function getSupport1DBarcode();
     ...
     * @return bool
     */
    abstract public function getSupport2DBarcode();
     ...
     * @return int
     */
    abstract public function getSupportFields();
     ...
     * @return bool
     */
    abstract public function getSupportLogo();
     ...
     * @return bool
     */
    abstract public function getSupportTitle();
     ...
     */
    abstract public function write(TCPDF $pdf, Collection $record);
     ...
     * @return string
     */
    final public function getOrientation()
    {
     ...
     */
    final public function getPrintableArea()
    {
        return (object) [
     ...
     */
    final public function writeText(TCPDF $pdf, $text, $x, $y, $font = null, $style = null, $size = null, $align = 'L', $width = null, $height = null, $squash = false, $border = 0, $spacing = 0)
    {
     ...
     */
    final public function writeImage(TCPDF $pdf, $image, $x, $y, $width = null, $height = null, $halign = 'L', $valign = 'L', $dpi = 300, $resize = false, $stretch = false, $border = 0)
    {
     ...
     * @param  float  $height  The container height
     */
    final public function write1DBarcode(TCPDF $pdf, $value, $type, $x, $y, $width, $height)
    {
        if (empty($value)) {
            return;
        }
     ...
     * @param  float  $height  The container height
     */
    final public function write2DBarcode(TCPDF $pdf, $value, $type, $x, $y, $width, $height)
    {
        if (empty($value)) {
            return;
        }
