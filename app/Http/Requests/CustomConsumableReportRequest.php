...
/**
 * Mirrors CustomComponentReportRequest — same validation shape, same
 * range-normalization tricks. Split into its own class rather than
 * shared with Component so the request-level rules can diverge later
 * without one form's changes silently affecting the other.
 */
class CustomConsumableReportRequest extends Request
{
