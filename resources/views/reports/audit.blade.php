            ...
            <div class="box box-default">
                <div class="box-body">
                    ...
                    <table
                        ...
                        <thead>
                        <tr>
                            <th scope="col" class="col-sm-1" data-field="file" data-visible="false" data-formatter="auditImageFormatter">{{ trans('general.image') }}</th>
                            <th scope="col" class="col-sm-2" data-field="created_by" data-sortable="true" data-searchable="true" data-formatter="usersLinkObjFormatter">{{ trans('general.created_by') }}</th>
