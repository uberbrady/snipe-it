                                            ...
                                            @if (($asset->checkedOutToUser()) && ($asset->assignedTo->present()->gravatar()))
                                                <li>
                                                    <img src="{{ $asset->assignedTo->present()->gravatar() }}"
                                                         class="user-image-inline hidden-print"
                                                         alt="{{ $asset->assignedTo->display_name }}">
                            ...
                            <div class="col-md-9 col-xs-12 col-sm-pull-3 info-stack">
                                ...
                                <div class="row-new-striped">
                                    ...
                                    <!-- byod -->
                                        ...
                                        </strong>{{-- Are we sure about this stray tag? --}}
                                </div>
                                <div class="col-md-9">
                        ...
                        <table class="table">
                            ...
                            @foreach ($asset->licenseseats as $seat)
                                @if ($seat->license)
                                    <tr>
                                        <td>
                                            <a href="{{ route('licenses.show', $seat->license->id) }}">{{ $seat->license->name }}</a>
                                        </td>
                                        <td>
                                            @can('viewKeys', $seat->license)
                                                <code class="single-line"><span class="js-copy-link"
                                                                                data-clipboard-target=".js-copy-key-{{ $seat->id }}"
                                                                                aria-hidden="true" data-tooltip="true"
                                                                                data-placement="top"
                                                                                title="{{ trans('general.copy_to_clipboard') }}"><span
                                                                class="js-copy-key-{{ $seat->id }}">{{ $seat->license->serial }}</span></span></code>
                                            @else
                                                ------------
                                            @endcan
                                        </td>
                            ...
                            @foreach ($asset->components as $component)
                                ...
                                @if (is_null($component->deleted_at))
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('components.checkin.show', $component->pivot->id) }}"
                                               class="btn btn-sm bg-purple hidden-print"
                                               data-tooltip="true">{{ trans('general.checkin') }}</a>
                                        </td>
                                ...
                                <table
                                    ...
                                    <tr>
                                        ...
                                        <th class="col-sm-2" data-field="file" data-sortable="true" data-visible="false"
                                            data-formatter="fileUploadNameFormatter">{{ trans('general.file_name') }}</th>
                                        <th data-field="note">{{ trans('general.notes') }}</th>
                                        <th data-visible="false" data-field="file" data-visible="false"
                                            data-formatter="fileDownloadButtonsFormatter">{{ trans('general.download') }}</th>
