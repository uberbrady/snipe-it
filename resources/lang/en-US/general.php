...
return [
    ...
    'calendar_event_maintenance' => 'Maintenance',
    'calendar_event_asset_audit_due' => 'Audit due',
    'calendar_event_asset_expected_checkin' => 'Expected checkin',
    'calendar_event_asset_checkout' => 'Checked out',
    'calendar_event_asset_eol' => 'Asset EOL',
    'calendar_event_asset_warranty_expiration' => 'Warranty expires',
    'calendar_event_license_expiration' => 'License expires',
    'calendar_event_license_termination' => 'License terminates',
    'calendar_event_user_end_date' => 'Employment end',
    'calendar_event_request_reservation' => 'Reservation',
    'calendar_truncation_banner' => 'Showing :returned of :total events in this range. Narrow the date range or use the filter buttons to see the rest.',
    'calendar_today_more' => '+:count more on the calendar',
    'calendar_upcoming' => 'Today & Up Next',
    'calendar_upcoming_more' => '+:count more on the calendar',
    'dashboard_low_stock' => 'Low Inventory',
    'dashboard_low_stock_none' => 'Nothing below its minimum quantity threshold.',
    'dashboard_attention' => 'Needs Attention',
    'dashboard_overdue_audits' => 'Audits overdue',
    'dashboard_overdue_checkins' => 'Checkins overdue',
    'dashboard_overdue_maintenances' => 'Maintenances overdue',
    'dashboard_unaccepted_assets' => 'Unaccepted acceptances',
    'dashboard_pending_requests' => 'Open checkout requests',
    'dashboard_licenses_expiring_soon' => 'Licenses expiring in 30 days',
    'dashboard_assets_past_eol' => 'Assets past EOL',
    'dashboard_users_offboarding_soon' => 'Employees offboarding in 30 days',
    'dashboard_low_stock_empty' => 'Nothing below its minimum quantity threshold.',
    'dashboard_low_stock_help' => 'Items show here when remaining quantity falls below the item\'s minimum plus the site-wide alert threshold (currently :threshold), set in Notifications settings.',
    'dashboard_activity_empty' => 'No recent activity yet.',
    'tag_color' => 'Tag Color',
    ...
    'pending' => 'Pending',
    'people' => 'People',
    'preserve_blank_cells_on_update' => 'Skip updating fields with blank cells',
    'preserve_blank_cells_on_update_help' => 'By default, a blank cell in a mapped column overwrites the existing value on update. Turn this on to skip blank cells so the existing value stays put. Columns you leave out of your CSV entirely are always preserved regardless of this setting.',
