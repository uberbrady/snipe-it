...
return [
    ...
    'assigned_quantity' => 'Priskirtas kiekis',
    'assignee' => 'Išduota',
    ...
    'bulk_restore' => 'Masinis atkūrimas',
    ...
    'custom_component_report' => 'Individualizuota komponentų ataskaita',
    ...
    'include_assignments' => 'Įtraukti užduotis',
    ...
    'newly_uploaded' => 'Ką tik įkelta',
    'import-history' => 'Paėmimų / išdavimų istorija',
    ...
    'active_maintenances' => 'Vykdomi aptarnavimai',
    'maintenance_cost' => 'Aptarnavimo kaina',
    ...
    'restored' => 'atkurta',
    'restore' => 'Atkurti',
    'impersonated' => 'Prisijungęs kaip',
    'impersonate' => 'Prisijungti kaip šis naudotojas',
    'stopped_impersonating' => 'Tapatybės prisiėmimas baigtas',
    ...
    'select_datetime' => 'Pasirinkite datą ir laiką (YYYY‑MM‑DD HH:MM:SS)',
    ...
    'no_import_files_yet' => 'Dar nėra importavimo failų. Norėdami pradėti, įkelkite CSV failą naudodamiesi dešinėje esančiu skydeliu.',
    ...
    'error_checkout_company_mismatch' => ':item negalima išduoti :target — :item priklauso :item_company',
    'error_location_scoped_items' => 'Šios vietos negalima išsaugoti. :item_type ":item_name" (Įmonė: :item_company) nesutampa su šios vietos įmone.',
    'error_location_parent_company' => 'Pagrindinė vieta „:parent“ priklauso :parent_company, tačiau ši vieta priklauso :location_company.',
    ...
    'bulk' => [
        'delete' => [
            ...
            'nothing_deletable' => 'Nei vieno iš pasirinktų :object_type negalima ištrinti.',
            'partial' => 'Panaikinti :success_count :object_type, bet :error_count :object_type negali būti panaikinti',
        ],
    ],
    'no_requestable' => 'Nėra užsakomo turto, turto modelių ar priedų.',
    ...
    'checkin_by_field' => 'Paimti pagal lauką',
    'checkin_by_field_help' => 'Paėmimas nuskaitant serijinius numerius yra galimas tik tuo atveju, jei administratoriaus nustatymuose nurodyta, kad serijiniai numeriai turi būti unikalūs.',
    'audit_key' => 'Turtas',
    ...
    'bulk_delete_associations' => [
        ...
        'assoc_assets' => ':item_name šiuo metu yra susietas su turto vienetais (:asset_count) ir negali būti panaikintas. Atnaujinkite savo turtą, kad nebebūtų sąsajos su :item, ir bandykite dar kartą.',
        'asset_models' => ':item_name šiuo metu yra susietas su turto vienetais (:asset_count) ir negali būti panaikintas. Atnaujinkite savo turto modelius, kad nebebūtų sąsajos su :item, ir bandykite dar kartą.',
        'assoc_maintenances' => ':item_name šiuo metu yra susietas su aptarnavimais (:maintenance_count) ir negali būti panaikintas. Atnaujinkite savo aptarnavimus, kad nebebūtų sąsajos su :item, ir bandykite dar kartą.',
        'assoc_accessories' => ':item_name šiuo metu yra susietas su priedais (:accessory_count) ir negali būti panaikintas. Atnaujinkite savo priedus, kad nebebūtų sąsajos su :item, ir bandykite dar kartą.',
        'assoc_consumables' => ':item_name šiuo metu yra susietas su eksploatacinėmis medžiagomis (:consumable_count) ir negali būti panaikintas. Atnaujinkite savo eksploatacines medžiagas, kad nebebūtų sąsajos su :item, ir bandykite dar kartą.',
        'assoc_components' => ':item_name šiuo metu yra susietas su komponentais (:component_count) ir negali būti panaikintas. Atnaujinkite savo komponentus, kad nebebūtų sąsajos su :item, ir bandykite dar kartą.',
        'assoc_licenses' => ':item_name šiuo metu yra susietas su licencijomis (:license_count) ir negali būti panaikintas. Atnaujinkite savo licencijas, kad nebebūtų sąsajos su :item, ir bandykite dar kartą.',
        ...
        'assoc_users_no_count' => ':item_name šiuo metu yra susietas su kitais naudotojais ir negali būti panaikintas. Atnaujinkite savo naudotojus, kad nebebūtų sąsajos su :item, ir bandykite dar kartą.',
        'assoc_child_companies_no_count' => ':item_name šiuo metu yra tėvinė įmonė kitoms įmonėms ir negali būti ištrinta. Prieš bandydami dar kartą, perskirkite arba ištrinkite dukterines įmones.',
        'assoc_checkouts_no_count' => ':item_name šiuo metu yra išduotas. Prieš ištrindami šį :item, paimkite visus su juo susijusius daiktus.',
    ],
