...
return [
    ...
    'image_filetypes_help' => 'Erlaubte Dateitypen sind jpg, webp, png, gif, svg, und avif. Die maximal zulässige Upload-Größe beträgt :size.',
    ...
    'add_users_to_group_help' => 'Verwenden Sie die Pfeile zum Hinzufügen oder Entfernen von Benutzern aus dieser Gruppe. Sie können mehrere Benutzer auswählen, indem Sie beim Klicken die Strg-Taste (Windows) oder Command (Mac) gedrückt halten.',
    'fields' => 'Felder',
    ...
    'system_default_help' => 'Dies wird Ihre Einstellungen für den hellen bzw. dunklen Modus zurücksetzen, um die Standardwerte in den Einstellungen Ihres Computerbetriebssystems zu verwenden.',
    'theme' => 'Leitmotiv',
    ...
    'bulk_delete_associations' => [
        ...
        'asset_models' => ':item_name ist derzeit mit :asset_count asset(s) verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Assets, um diese :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
        'assoc_maintenances' => ':item_name ist derzeit mit :maintenance_count maintenance(s) verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Wartungen, um diese :item nicht mehr zu referenzieren und versuchen Sie es erneut.',
        'assoc_accessories' => ':item_name ist derzeit mit :accessory_count accessory(ies) verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihr Zubehör, um diese :item nicht mehr zu referenzieren und versuchen Sie es erneut.',
        'assoc_consumables' => ':item_name ist derzeit mit :consumable_count consumable(s) verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Verbrauchsmaterialien, um diese :item nicht mehr zu referenzieren und versuchen Sie es erneut.',
        'assoc_components' => ':item_name ist derzeit mit :component_count component(s) verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Komponenten, um diese :item nicht mehr zu referenzieren und versuchen Sie es erneut.',
        'assoc_licenses' => ':item_name ist derzeit mit :license_count license(s) verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Lizensen, um diese :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
        'assoc_assets_no_count' => ':item_name ist derzeit mit anderen Assets verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Assets, um dieses :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
        'asset_models_no_count' => ':item_name ist derzeit mit anderen Asset-Modellen verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Assets, um dieses :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
        'assoc_maintenances_no_count' => ':item_name ist derzeit mit anderen Wartungen verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Wartungen, um diesen :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
        'assoc_accessories_no_count' => ':item_name ist derzeit mit anderen Zubehörteilen verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihr Zubehör, um dieses :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
        'assoc_consumables_no_count' => ':item_name ist derzeit mit anderen Verbrauchsmaterialien verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Verbrauchsmaterialien, um diese :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
        'assoc_components_no_count' => ':item_name ist derzeit mit anderen Komponenten verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Komponenten, um diesen :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
        'assoc_licenses_no_count' => ':item_name ist derzeit mit anderen Lizenzen verknüpft und kann nicht gelöscht werden. Bitte aktualisieren Sie Ihre Lizenzen, um diesen :item nicht mehr zu referenzieren, und versuchen Sie es erneut.',
