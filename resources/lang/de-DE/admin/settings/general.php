...
return [
    ...
    'color_settings_help' => 'Diese Einstellungen werden durchweg in Snipe-IT verwendet. Benutzer haben die Möglichkeit, die Farbe von Links in ihren Account-Einstellungen individuell anzupassen, um eine optimale Lesbarkeit sicherzustellen.',
    ...
    'acceptance_note' => 'Fügen Sie eine Notiz zu Ihrer Entscheidung hinzu (erforderlich bei Ablehnung)',
    ...
    'api_url' => 'API Standard URL',
    'scim_url' => 'SCIM Basis-URL',
    'general_settings_help' => 'Standard EULA und mehr',
    'generate_backup' => 'Backup erstellen',
    'google_workspaces' => 'Google Workspaces',
    'header_color' => 'Primäre Themen-Farbe',
    'header_color_help' => 'Wenn Sie hier eine neue Farbe auswählen, können Sie sich eine Vorschau zusammen mit ihrem Logo (Wenn sie ein Logo hochgeladen haben) in der Kopfzeile anzeigen. Die neue Farbe wird erst dann gespeichert, wenn sie auf die Schaltfläche Speichern klicken.',
    'link_dark_color' => 'Farbe der Links im Dunkel Modus',
    'nav_link_color' => 'Farbe der Navigationslinks in der Kopfzeile',
    'nav_link_color_help' => 'Wählen Sie eine Farbe für die Navigationslinks in der Kopfzeile. Diese Farbe sollte hoch genug im Kontrast zu Ihrer Kopfzeilenfarbe sein, um leicht lesbar zu sein.',
    'link_dark_color_help' => 'Wählen Sie eine Farbe, die genügend Kontrast für Personen bietet, die Snipe-IT im Dunkel Modus verwenden.',
    'link_light_color' => 'Farbe der Links im Hell Modus',
    'link_light_color_help' => 'Wählen Sie eine Farbe, die genügend Kontrast für Personen bietet, die Snipe-IT im Hell Modus verwenden.',
    ...
    'ldap_location_help' => 'Das Feld LDAP Standort sollte verwendet werden, wenn <strong>keine OU im Basis Bind DN verwendet wird.</strong> Lassen Sie es leer, wenn eine OU-Suche verwendet wird.',
    ...
    'ldap_login_sync_help' => 'Dies testet nur, ob die LDAP-Synchronisation funktioniert und ob die Attribute korrekt abgebildet sind. Wenn die LDAP Authentifikationsabfrage nicht korrekt ist können sich Benutzer möglicherweise dennoch nicht anmelden. VOR DEM TEST MÜSSEN SIE IHRE LDAP-EINSTELLUNGEN SPEICHERN.',
    'ldap_manager' => 'Manager Field',
    'ldap_mapping_help' => 'Wenn Ihre Felder nicht korrekt synchronisiert werden, verwenden Sie bitte die <strong>Kleinbuchstaben Version</strong> der Feldnamen. Anzeigename (<code>AnzeigeName</code>) in Ihrem LDAP/AD sollte hier als <code>AnzeigeName</code>zugeordnet werden <code>Vorname</code> sollte <code>Vorname</code>, <code>sAMKontoName</code> as <code>samkontoname</code>, etc. sein. <a href="https://snipe-it.readme.io/docs/ldap-sync-login#field-mapping-for-syncing"><i class="fa fa-external-link"></i></a>',
    ...
    'ldap_display_name_help' => 'Wenn es ein separates <code>displayName</code> Attribut in Ihrem LDAP/AD gibt, dann können Sie es hier abbilden, womit dieses dann für die Darstellung der Benutzernamen in Snipe-IT verwendet wird.',
    ...
    'labels_title_help' => 'Hier vorgenommene Änderungen müssen gespeichert werden, bevor sie sich in den Etiketten oder in der Vorschau unten widerspiegeln.',
    'labels_help' => 'Barcodes &amp; Etiketteneinstellungen',
    'purge_help' => 'Soft-gelöschte Datensätze dauerhaft löschen',
    ...
    'create_admin_redirect' => 'Zum Dashboard',
    ...
    'setup_migration_create_user' => 'Benutzer speichern und abschließen',
    'ldap_settings_link' => 'LDAP Einstellungsseite',
    'setup_create_user_page_explanation' => 'Hier werden Sie Ihren ersten Superadmin Benutzer erstellen und einige grundlegende Einstellungen für die Anwendung festlegen. (Diese können später im Bereich Admin-Einstellungen geändert werden.) ',
    ...
    'label2_2d_prefix' => '2D Barcode Präfix',
    'label2_2d_prefix_help' => 'Dieser Text wird dem unten ausgewählten 2D Barcode Zielwert vorangestellt, wenn der 2D Code gescannt wird. Dies kann verwendet werden, um eine externe URL oder einen anderen Wert, den Sie vielleicht benötigen, vorzuziehen.',
    'label2_2d_target' => '2D Barcode Inhalt',
    'label2_2d_target_help' => 'Die Daten, die im 2D Barcode enthalten sein werden. Dies kann direkt mit dem Gegenstand in Snipe-IT verbinden oder einer der nicht verknüpften Feldwerte sein. Wenn Sie das Präfix oben verwenden, wird es diesem Wert vorangestellt.',
    ...
    'help_default_will_use' => 'Beachten Sie, dass der Wert der Barcodes mit der jeweiligen Barcode-Spezifikation übereinstimmen muss, um erfolgreich generiert zu werden. Bitte lesen Sie <a href="https://snipe-it.readme.io/docs/barcodes">die Dokumentation <i class="fa fa-external-link"></i></a> für weitere Details. ',
    'asset_id' => 'Asset-ID',
    'data' => 'Daten',
    'default' => 'Standard',
    'none' => 'Nichts',
    ...
    'client_secret' => 'Kunden Geheimschlüssel (Secret)',
    'client_id' => 'Kunden-ID',
    ...
    'update_existing_dates' => 'Aktualisieren Sie auch alle vorhandenen "nächsten Auditdaten" für Assets mit einem bevorstehenden Audit Intervall oben. Dies wird am häufigsten verwendet, wenn sich die internen Richtlinien für Audit-Intervall geändert haben.',
    ...
    'email_formats' => [
        ...
        'firstinitial_lastname' => 'Initiale des Vornamen.Nachname (e.mustermann@example.com)',
