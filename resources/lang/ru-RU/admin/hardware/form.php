...
return [
    ...
    'asset_not_deployable_checkin' => '{1} статус этого актива не установлен. Использование ярлыка статуса проверит в активе. [2,*] Состояние активов не применяется. Использование этой метки состояния не приведет к изменениям.',
    'asset_deployable' => '{1} Этот актив можно извлечь.|[2,*] Эти активы можно извлечь.',
    ...
    'checkin_licenses' => 'Проверка связанных лицензионных мест',
    'checkin_child_assets' => 'Проверка связанных активов',
];
