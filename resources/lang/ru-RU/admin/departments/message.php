...
return [
    ...
    'delete' => [
        ...
        'bulk_success' => 'Отдел успешно удален.|:count отделов были успешно удалены.',
        'partial_success' => 'Отдел успешно удален. Смотрите дополнительную информацию ниже. | :count отделов были удалены. Смотрите дополнительную информацию ниже.',
    ],
