...
return [
    ...
    'delete' => [
        ...
        'bulk_success' => 'Метка статуса успешно удалена.|:count метки статуса успешно удалены.',
        'partial_success' => 'Метка состояния успешно удалена. Смотрите дополнительную информацию ниже. | :count Меток статуса были успешно удалены. Смотрите дополнительную информацию ниже.',
    ],
