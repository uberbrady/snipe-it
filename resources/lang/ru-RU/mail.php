...
return [
    ...
    'Expected_Checkin_Date_Past' => 'Актив выданный вам ранее должен был быть возвращен :date.',
    'Expected_Checkin_Notification' => 'Напоминание: приближается крайний срок проверки :name',
    'Expected_Checkin_Notification_Pastdue' => 'ПРОСРОЧЕНО: :name просрочил(а) дату возврата актива',
    ...
    'acceptance_accepted' => 'ПОДТВЕРЖДЕНО: :user принял(а) :item',
    'acceptance_declined' => 'ОТКЛОНЕНО: :user отклонил(а) :item',
    'acceptance_accepted_greeting' => ':user принял элемент',
    'acceptance_declined_greeting' => ':user отклонил элемент',
    ...
    'assigned_to' => 'Выдано',
    'assigned_to_assets' => 'Назначения активов',
    'eol' => 'Срок службы',
    ...
    'items_checked_out_require_acceptance' => 'Товар для оформления элементов требует подтверждения.|Один или несколько элементов требуют подтверждения.',
    ...
    'read_the_terms_and_click' => 'Пожалуйста, прочитайте условия использования ниже, и нажмите на ссылку внизу, чтобы подтвердить, что вы прочитали и согласны с условиями использования, и получили этот элемент.',
    'click_here_to_review_terms_and_accept_item' => 'Нажмите здесь, чтобы просмотреть условия использования и принять элемент|Нажмите здесь, чтобы просмотреть условия использования и принять элементы',
    'requested' => 'Запрошено',
