...
return [
    ...
    'accept_items' => 'Принять активы',
    'audit' => 'аудит',
    'audited' => 'Проверено',
    'audited_by' => 'Проверено',
    'audits' => 'Аудиты',
    ...
    'tag_color_help' => 'Если вы хотите использовать собственный цветовой индикатор для этой записи, введите шестнадцатеричный код цвета (например, #ffffff для белого). В противном случае поле можно оставить пустым.',
    'checkin' => 'Привязать',
    ...
    'clear_name' => 'Очистить имя актива',
    'clear_selection' => 'Очистить выбор',
    'companies' => 'Компании',
    'companies_var' => 'Компания | Компании',
    'company' => 'Компания',
    'component' => 'Компонент',
    ...
    'updated_before' => 'Обновлено ранее',
    'updated_plain' => 'Обновлено',
    ...
    'custom_component_report' => 'Пользовательский отчет о компоненте',
    ...
    'depreciation_type' => 'Тип амортизации',
    ...
    'first_checkout' => '1<sup>ая</sup> Выдача',
    'generate' => 'Сгенерировать',
    'generate_labels' => 'Сгенерировать метки',
    'github_markdown' => 'Поле поддерживает разметку<a href="https://help.github.com/articles/github-flavored-markdown/" target="_blank">Github flavored markdown</a>.',
    'groups' => 'Группы',
    ...
    'include_assignments' => 'Включить задания',
    ...
    'import' => 'Импорт',
    'documentation' => 'Открыть документацию в новой вкладке',
    'import_this_file' => 'Сопоставить поля и обработать этот файл',
    'importing' => 'Импортируется',
    'importing_help' => 'CSV-файл должен быть разделён запятыми и отформатирован с заголовками, соответствующими заголовкам в <a href="https://snipe-it.readme.io/docs/importing" target="_new">примерах CSV-файлов из документации <i class="fa fa-external-link"></i></a>.',
    ...
    'licenses_with_no_seats' => 'Лицензии без доступных мест для использования',
    'licenses' => 'Лицензии',
    ...
    'active_maintenances' => 'Обслуживания активов',
    'maintenance_cost' => 'Стоимость технического обслуживания',
    'maintenance_complete' => 'Обслуживание завершено',
    'manage_api_keys' => 'Управление ключами API',
    'manufacturer' => 'Производитель',
    'manufacturers' => 'Производители',
    'markdown' => 'Поддерживается Markdown',
    'min_amt' => 'Мин Кол-во',
    'min_amt_help' => 'Минимальное число активов, которые должны быть доступны до срабатывания предупреждения. Оставьте Мин. число пустым, если вы не хотите получать оповещения о низких запасах.',
    'model_no' => 'Модель',
    'months' => 'Месяцев',
    'moreinfo' => 'Подробнее',
    'name' => 'Имя',
    ...
    'device_eol' => 'Срок службы устройства',
    'na' => 'Н/Д',
    ...
    'purchase_cost_format_help' => 'Это значение следует ввести в числовом формате, настроенном в вашей системе, например :format',
    'purchase_cost_invalid' => 'Пожалуйста, введите корректное число (только цифры, точки и запятые)',
    ...
    'impersonated' => 'Вы вошли как',
    'impersonate' => 'Войти как',
    'stopped_impersonating' => 'Остановка работы от имени другого пользователя',
    ...
    'audit_due_days_view_all' => '{}Активы, подлежащие или просроченные для аудита |[1]Активы, подлежащие или просроченные для аудита в течение дня|[2,*]Активы, подлежащие или просроченные для аудита в течение :days дней',
    ...
    'available_users' => 'Доступные пользователи для добавления',
    'add_users_to_group' => 'Добавить пользователей в группу',
    'users_to_add_to_group' => 'Пользователи для добавления',
    'add_all_users_to_group' => 'Добавить всех пользователей в группу',
    'add_selected_users_to_group' => 'Добавить выбранных пользователей в группу',
    'remove_selected_users_from_group' => 'Удалить выбранных пользователей из группы',
    'remove_all_users_from_group' => 'Удалить всех пользователей из группы',
    'add_users_to_group_help' => 'Используйте стрелки для добавления или удаления пользователей из этой группы. Вы можете выбрать нескольких пользователей, удерживая нажатой клавишу Ctrl (Windows) или Command (Mac).',
    'fields' => 'Поля',
    ...
    'export' => 'Экспорт',
    'export_all_to_csv' => 'Экспортировать все в CSV',
    ...
    'checkouts_checkins' => 'Выдачи и возвраты',
    'assets_newly_added' => 'Активы добавлены',
    'checkouts' => 'Отвязать',
    'checkins' => 'Возвраты',
    'assets' => 'Активы',

    'vs_prior_period' => 'по сравнению с предыдущим периодом',
    'time_range' => 'Выберите диапазон дат',
    'last_n_days' => 'Последние :days дней',
    'custom_range' => 'Настраиваемый Диапазон',
    'download_chart' => 'Скачать диаграмму в формате PNG',
    'fullscreen' => 'Полноэкранный режим',
    'pie_chart_type' => 'Тип диаграммы Pie в Дашборде',
    'hello_name' => 'Добро пожаловать, :name!',
    'unaccepted_profile_warning' => '{1} У вас есть один элемент, требующий подтверждения. Нажмите здесь, чтобы подтвердить или отклонить его|[2,4] У вас есть :count элементов, требующих подтверждения. Нажмите здесь, чтобы подтвердить или отклонить их|[5,*] У вас есть :count элементов, требующих подтверждения. Нажмите здесь, чтобы подтвердить или отклонить их',
    ...
    'light_dark' => 'Светлый/Темный режим',
    'system_default' => 'Использовать системные настройки',
    'system_default_help' => 'Это сбросит настройки светлого/темного режима, чтобы использовать значения по умолчанию в настройках операционной системы вашего компьютера.',
    'theme' => 'Тема оформления',
    'fmcs_select_note' => 'Включена полная поддержка нескольких компаний. Выборы других компаний могут не отображаться в этом списке.',
    'fmcs_location_select_note' => 'Включена полная поддержка нескольких компаний с возможностью выбора местоположения. В этом списке будут отображаться только местоположения, принадлежащие вашей компании.',
    'fmcs_company_select_note' => 'Включена полная поддержка нескольких компаний. Вы можете назначать только те компании, в которых состоите.',
    'fmcs_company_select_superadmin_note' => 'Полная поддержка компании включена. Указанная здесь компания может повлиять на видимость пользователей без прав супер-администратора.',
    ...
    'error_checkout_company_mismatch' => ':item не может быть выдан на :target — :item принадлежит :item_company',
    'error_location_scoped_items' => 'Это местоположение не может быть сохранено. :item_type ":item_name" (Компания: :item_company) не соответствует компании этого местоположения.',
    'error_location_parent_company' => 'Родительское местоположение ":parent" относится к :parent_company, а это местоположение — к :location_company.',
    'error_assets_already_checked_out' => 'Один или несколько активов уже выданы',
    'assigned_assets_removed' => 'Следующие элементы были удалены из списка выбранных ресурсов, так как они уже проверены',
    'unassigned_assets_removed' => 'Следующие элементы были удалены из списка выбранных ресурсов, так как в данный момент они не проверены',
    'upload_files' => 'Загрузить файлы',
    'uploaded_files' => 'Загруженные файлы',
    'sign_in_place' => 'Подписать/Принять на месте',
    'sign_in_place_help' => 'Установите этот флажок, если пользователь находится рядом и вы хотите, чтобы он принял товар и подписал/одобрил лицензионное соглашение (если применимо) прямо сейчас.',
    'unauthorized' => 'Неавторизованный или неаутентифицированный.',
    'importer' => [
    ...
    'item_target_not_found_hard' => ':item_type ID :id не существует или был удален. Вы хотите принудительно осуществить возврат?',
    'force_checkin' => 'Принудительный возврат',
    'item_not_found_short' => ':item_type ID :id не существует',
    ...
    'edit' => 'редактировать',
    'search_operator' => 'Оператор поиска',
    'and' => 'и',
    'action_source' => 'Источник действия',
    'search_tip' => 'По умолчанию поиск возвращает частичное совпадение. Для получения более точных результатов можно использовать <code>not:value</code> для нечеткого исключения, <code>is:value</code> для точного совпадения, <code>is_not:value</code> для точного исключения, <code>is:null</code> для пустых значений и <code>is:not_null</code> для непустых значений. (В этих примерах <code>value</code> — это искомый текст.)',
    'or' => 'или',
    'url' => 'Адрес',
    'phone' => 'Телефон',
    'fax' => 'Факс',
    ...
    'show_expiring' => 'Скоро истекает срок действия или заканчивается',
    'more_info' => 'Подробнее',
    ...
    'user_managed_passwords_bulk_help' => 'Этот параметр будет применен только к пользователям, которым вы можете редактировать настройки аутентификации.',
    'from' => 'От',
    'by' => 'Кем',
    'by_user' => 'Кем',
    'ldap_sync_location' => 'Синхронизировать всех пользователей с этим местоположением (необязательно)',
    'version' => 'Версия',
    'build' => 'Билд',
    ...
    'footer_credit' => '<a target="_blank" href="https://snipeitapp.com" rel="noopener">Snipe-IT</a> это программное обеспечение с открытым исходным кодом, созданное с <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">любовью</span> by Grokability, Inc.',
    'set_password' => 'Установить пароль',
    'upload_deleted' => 'Загрузка удалена',
    'child_locations' => 'Дочерние места',
    'append' => 'Добавить',
    'optional' => 'НЕОБЯЗАТЕЛЬНЫЙ',
    'audit_by_field' => 'Проверка по полю',
    'audit_by_field_help' => 'Аудит с помощью сканирования серийных номеров доступен только в том случае, если в настройках администратора указано, что серийные номера должны быть уникальными.',
    ...
    'last_note' => 'Последняя заметка',
    'bulk_delete_associations' => [
        'general_assoc_warning' => 'С :item_name по-прежнему связаны другие элементы. Пожалуйста, удалите их, прежде чем удалять этот :item.',
        'assoc_assets' => ':item_name в настоящее время связан с :asset_count активом(ми) и не может быть удалено. Пожалуйста, обновите ваши активы, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'asset_models' => ':item_name в настоящее время связан с :asset_count активом(ми) и не может быть удален. Пожалуйста, обновите модели активов, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_maintenances' => ':item_name в настоящее время связан с обслуживанием :maintenance_count и не может быть удален. Пожалуйста, обновите технические работы, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_accessories' => ':item_name в настоящее время связан с :accessory_count аксессуарами (аксессуарами) и не может быть удален. Пожалуйста, обновите аксессуары, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_consumables' => ':item_name в данный момент связан с :consumable_count расходником(ми) и не может быть удален. Обновите информацию о расходуемых предметах, чтобы больше не ссылаться на это :item и повторите попытку.',
        'assoc_components' => ':item_name в настоящее время связан с :component_count компонентом(ми) и не может быть удален. Пожалуйста, обновите компоненты чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_licenses' => ':item_name в настоящее время связан с :license_count лицензией(ми) и не может быть удален. Пожалуйста, обновите ваши лицензии, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_assets_no_count' => ':item_name в настоящее время связан с другими активами и не может быть удален. Пожалуйста, обновите ваши активы, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'asset_models_no_count' => ':item_name в настоящее время связан с другими моделями активов и не может быть удален. Пожалуйста, обновите ваши активы, чтобы больше не ссылаться на это :item и повторите попытку.',
        'assoc_maintenances_no_count' => ':item_name в настоящее время связан с другими техническими работами и не может быть удален. Обновите технические работы, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_accessories_no_count' => ':item_name сейчас связан с другими аксессуарами и не может быть удален. Пожалуйста, обновите аксессуары, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_consumables_no_count' => ':item_name в настоящее время связан с другими расходными материалами и не может быть удален. Обновите информацию о расходных материалах, чтобы больше не ссылаться на это :item и повторите попытку.',
        'assoc_components_no_count' => ':item_name в настоящее время связан с другими компонентами и не может быть удален. Пожалуйста, обновите компоненты, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_licenses_no_count' => ':item_name сейчас связан с другими лицензиями и не может быть удален. Пожалуйста, обновите ваши лицензии, чтобы больше не ссылаться на эту :item и повторите попытку.',
        'assoc_users_no_count' => ':item_name в настоящее время связан с другими пользователями и не может быть удален. Пожалуйста, обновите ваших пользователей, чтобы больше не ссылаться на этот :item и повторите попытку.',
        'assoc_child_companies_no_count' => ':item_name в настоящее время является родителем других компаний и не может быть удален. Пожалуйста, переназначьте или удалите дочерние компании, прежде чем попытаться снова.',
        'assoc_checkouts_no_count' => ':item_name в настоящее время выдан. Пожалуйста, проверьте все элементы перед удалением :item.',
    ],
    ...
    'report_not_editable' => 'У вас недостаточно прав для редактирования шаблона этого отчета',
    ...
    'token_unrevoked' => 'Токен API восстановлен',
    'token_revoked' => 'Токен API отозван',
