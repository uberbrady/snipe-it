...
return [
    ...
    'action' => 'ایکشن',
    'action_date' => 'ایکشن کی تاریخ',
    'activity_report' => 'سرگرمی کی رپورٹ',
    'address' => 'پتہ',
    'admin' => 'ایڈمن کی ترتیبات',
    'admin_user' => 'ایڈمن صارف',
    'admin_tooltip' => 'اس صارف کو ایڈمن کے اختیارات حاصل ہیں',
    'superuser' => 'سپر ایڈمن',
    'superuser_tooltip' => 'اس صارف کے پاس سپر ایڈمن کے اختیارات ہیں',
    'administrator' => 'ایڈمنسٹریٹر',
    'add_seats' => 'نشستیں شامل کی گئی',
    'age' => 'عمر',
    'all_assets' => 'تمام اثاثے',
    'all' => 'تمام',
    'archived' => 'Archived',
    'asset_models' => 'اثاثوں کے ماڈل',
    'asset_model' => 'ماڈل',
    'asset' => 'اثاثہ',
    'asset_previous' => 'اثاثہ(پہلے تفویض کردہ)',
    'asset_report' => 'اثاثہ جات رپورٹ',
    'asset_tag' => 'اثاثے کا ٹیگ',
    'asset_tags' => 'اثاثے کے ٹیگز',
    'available' => 'Available',
    'assets_available' => 'موجودہ اثاثے',
    'accept_assets' => 'قابل قبول اثاثہ :name',
    'accept_assets_menu' => 'قابل قبول اثاثے',
    'accept_item' => 'آئٹم کو منظور کریں',
    'accept_items' => 'Accept Items',
    'audit' => 'آڈٹ',
    'audited' => 'Audited',
    'audited_by' => 'Audited By',
    'audits' => 'آڈٹ',
    'audit_report' => 'آڈٹ کے لوگز',
    'assets' => 'اثاثے',
