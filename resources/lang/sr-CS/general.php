...
return [
    ...
    'accept_items' => 'Prihvati stavke',
    'audit' => 'Revizija',
    'audited' => 'Prošlo reviziju',
    'audited_by' => 'Revizor',
    'audits' => 'Revizije',
    ...
    'tag_color' => 'Boja oznake',
    'tag_color_help' => 'Ukoliko želite da koristite indikator sa prilagođenom bojom za ovaj unos, upišite njenu heksadecimalnu vrednost (npr. #ffffff za belu). U suprotnom, možete ostaviti prazno.',
    'checkin' => 'Checkin',
    ...
    'clear_all_filters' => 'Očisti sve filtere',
    'clear_name' => 'Očisti naziv imovine',
    'clear_selection' => 'Poništi izbor',
    'companies' => 'Firme',
    'companies_var' => 'Kompanija|Kompanije',
    'company' => 'Firma',
    ...
    'custom_component_report' => 'Prilagođeni izveštaj o komponentama',
    'dashboard' => 'Dashboard',
    ...
    'delete_confirm_no_undo' => 'Da li ste sigurni da želite da obrišete :item? Ovo nije moguće poništiti.',
    'deleted' => 'Izbrisano',
    ...
    'include_assignments' => 'Uvrsti dodeljivanja',
    ...
    'importing' => 'Uvoženje',
    'importing_help' => 'CSV treba biti razdvojen zarezom i formatiran sa zaglavljima koji se poklapaju sa onima u <a href="https://snipe-it.readme.io/docs/importing" target="_new">primerom CSV-a iz dokumentacije <i class="fa fa-external-link"></i></a>.',
    'newly_uploaded' => 'Upravo otpremljeno',
    'import-history' => 'Istorija razduživanja/zaduživanja',
    ...
    'licenses_with_no_seats' => 'Licence sa svim zauzetim sedištima',
    'licenses' => 'Licence',
    'list_all' => 'Lista svih',
    ...
    'active_maintenances' => 'Aktivna održavanja',
    'maintenance_cost' => 'Cena održavanja',
    'maintenance_complete' => 'Održavanje je završeno',
    'manage_api_keys' => 'Upravljate API ključevima',
    'manufacturer' => 'Proizvođač',
    'manufacturers' => 'Proizvođači',
    'markdown' => 'Markdaun je podržan',
    'min_amt' => 'Min. Kol',
    'min_amt_help' => 'Minimalni broj ove stavke koji bi trebao biti dostupan za zaduživanje pre nego što se aktivira upozorenje. Ostavite prazno ako ne želite da primate obaveštenja za malu količinu u inventaru.',
    'model_no' => 'Model br.',
    'months' => 'meseci',
    ...
    'options' => 'Opcije',
    'preview' => 'Pregled',
    'add_note' => 'Dodaj belešku dnevnika',
    ...
    'purchase_cost_format_help' => 'Ovo treba biti unešeno u formatu brojeva podešenom u vašem sistemu, npr. :format',
    'purchase_cost_invalid' => 'Molim vas unesite ispravan broj (samo cifre, tačke i zarezi)',
    ...
    'restore' => 'Povrati',
    'impersonated' => 'Prijavljen kao',
    'impersonate' => 'Prijavite se kao ovaj korisnik',
    'stopped_impersonating' => 'Zaustavljeno predstavljanje',
    ...
    'select_datetime' => 'Izaberite datum i vreme (YYYY-MM-DD HH:MM:SS)',
    ...
    'accepted' => 'accepted',
    'declined' => 'declined',
    'declined_date' => 'Datum odbijanja',
    'declined_note' => 'Odbijene napomene',
    'unassigned' => 'Nedodeljeno',
    'unaccepted_asset_report' => 'Neprihvaćene stavke',
    'users' => 'Korisnici',
    'viewall' => 'Prikaži svе',
    ...
    'file_not_inlineable' => 'Zahtevana datoteka ne može biti otvorena u vašem pregledaču. Umesto toga je možete preuzeti.',
    'open_new_window' => 'Otvori ovu datoteku u novom prozoru',
    'file_upload_success' => 'Uspešno postavljanje datoteke!',
    'no_files_uploaded' => 'Nijedna datoteka nije postavljena.',
    'no_import_files_yet' => 'Još nema datoteka za uvoz. Otpremite CSV koristeći panel sa desne strane da bi ste započeli.',
    ...
    'audit_due_days_view_all' => '{}Imovine u roku ili preko roka za popis|[1]Prikaži svu imovinu u roku ili preko roka za popis za jedan dan|[2,*]Prikaži svu imovinu u roku ili preko roka za popis u okviru :days dana',
    ...
    'available_users' => 'Dostupni korisnici za dodavanje',
    'add_users_to_group' => 'Dodaj korisnike u grupu',
    'users_to_add_to_group' => 'Korisnici za dodavanje',
    'add_all_users_to_group' => 'Dodaj sve korisnike u grupu',
    'add_selected_users_to_group' => 'Dodaj izabrane korisnike u grupu',
    'remove_selected_users_from_group' => 'Ukloni izabrane korisnike iz grupe',
    'remove_all_users_from_group' => 'Ukloni sve korisnike iz grupe',
    'add_users_to_group_help' => 'Koristite strelice za dodavanje i uklanjanje korisnika iz ove grupe. Možete izabrati više korisnika držeći taster Ctrl (Windows) ili Command (Mac) dok klikćete.',
    'fields' => 'Polja',
    ...
    'bulk_soft_delete' => 'Takođe meko-izbriši ove korisnike. Istorija njihovih stavki će ostati nedirnuta osim ako/dok trajno ne obrišete zapise u Administratorskim podešavanjima.',
    ...
    'assets_by_category' => 'Imovine prema kategoriji',
    ...
    'checkouts_checkins' => 'Zaduženja i razduženja',
    'assets_newly_added' => 'Imovina je dodata',
    'checkouts' => 'Checkouts',
    'checkins' => 'Razduženja',
    'assets' => 'Imovina',

    'vs_prior_period' => 'u odnosu na prethodni period',
    'time_range' => 'Izaberite opseg datuma',
    'last_n_days' => 'Poslednjih :days dana',
    'custom_range' => 'Prilagođeni opseg',
    'download_chart' => 'Preuzmite grafikon kao PNG',
    'fullscreen' => 'Pun ekran',
    'pie_chart_type' => 'Tip grafikona pite na radnoj tabli',
    'hello_name' => 'Pozdrav, :name!',
    'unaccepted_profile_warning' => '{1} Imate jednu stavku koja zahteva prihvatanje. Kliknite ovde da je prihvatite ili odbijete|[2,4] Imate :count stavke koje zahtevaju prihvatanje. Kliknite ovde da ih prihvatite ili odbijete|[5,*] Imate :count stavki koje zahtevaju prihvatanje. Kliknite ovde da ih prihvatite ili dobijete',
    ...
    'toggle_password_visibility' => 'Promeni vidljivost lozinke',
    'alerts' => 'Upozorenja',
    ...
    'light_mode' => 'Svetli prikaz',
    'dark_mode' => 'Tamni prikaz',
    'light_dark' => 'Svetli/tamni režim',
    'system_default' => 'Koristi podešavanja sistema',
    'system_default_help' => 'Ovo će vratiti vaša podešavanja svetlog/tamnog režima da koristi postavke iz vašeg operativnog sistema.',
    'theme' => 'Tema',
    'fmcs_select_note' => 'Omogućena je puna podrška za Višestruko kompanija. Pripadajuće drugim kompanijama se neće pojavljivati u ovom spisku.',
    'fmcs_location_select_note' => 'Omogućena je puna podrška za Višestruko kompanija sa lokacijskim opsegom. Samo lokacije koje pripadaju vašoj kompaniji će se pojavljivati u ovom spisku.',
    'fmcs_company_select_note' => 'Omogućena je puna podrška za Višestruko kompanija. Možete dodeliti samo kompanije kojima pripadate.',
    'fmcs_company_select_superadmin_note' => 'Omogućena je puna podrška za Višestruko kompanija. Kompanija koja je ovde dodeljena može uticati na vidljivost korisnika koji nisu superadmini.',
    ...
    'error_checkout_company_mismatch' => ':item se ne može zadužiti :target — :item pripada :item_company',
    'error_location_scoped_items' => 'Ova lokacija se ne može sačuvati. :item_type ":item_name" (Kompanija: :item_company) se ne poklapa sa lokacijom ove kompanije.',
    'error_location_parent_company' => 'Nadlokacija ":parent" pripada :parent_company, ali ova lokacija pripada :location_company.',
    ...
    'unassigned_assets_removed' => 'Sledeće je uklonjeno iz izabrane imovine zato što trenutno nije zaduženo',
    ...
    'location_edit_help' => 'Ukoliko se ostavi prazno, lokacija će biti ažurirana prema lokaciji onoga kome je imovina zadužena.',
    'item_not_found' => ':item_type ID :id ne postoji ili je obrisan',
    'item_target_not_found_hard' => ':item_type ID :id ne postoji ili je nasilno izbrisana. Da li želite da primorate zaduživanje?',
    'force_checkin' => 'Primorano zaduženje',
    'item_not_found_short' => ':item_type ID :id ne postoji',
    ...
    'edit' => 'uredi',
    'search_operator' => 'Operator pretrage',
    'and' => 'i',
    'action_source' => 'Izvor aktivnosti',
    'search_tip' => 'Pretrage podrazumevano vraćaju delimično poklapanje. Za specifične rezultate, možete koristiti <code>not:vrednost</code> za približan izuzetak, <code>is:vrednost</code> za tačno poklapanje, <code>is_not:vrednost</code> za tačan izuzetak, <code>is:null</code> za prazne vrednosti, i <code>is:not_null</code> za ne prazne vrednosti. (U ovim primerima, <code>vrednost</code> je tekst koji pretražujete.)',
    'or' => 'ili',
    'url' => 'URL adresa',
    'phone' => 'Telefon',
    'fax' => 'Fax',
    'contact' => 'Kontakt',
    'show_admins' => 'Admin korisnik',
    'show_superadmins' => 'Super korisnici',
    ...
    'bulk' => [
        'delete' => [
            ...
            'nothing_deletable' => 'Nijedan od izabranih :object_type može biti izbrisan.',
            'partial' => 'Obrisano :success_count :object_type, ali :error_count :object_type nije moglo biti obrisano',
        ],
    ],
    'no_requestable' => 'Nema zatražive imovine, modela imovine ili dodatne opreme.',
    ...
    'user_managed_passwords_bulk_help' => 'Ova postavka će biti primenjena samo za korisnike za koje možete da promenite postavku autentifikacije.',
    'from' => 'Od',
    'by' => 'By',
    'by_user' => 'By',
    'ldap_sync_location' => 'Sinhornizuj sve korisnike sa ovom lokacijom (opciono)',
    'version' => 'Verzija',
    'build' => 'izdanje',
    ...
    'footer_credit' => '<a target="_blank" href="https://snipeitapp.com" rel="noopener">Snipe-IT</a> je softver otvorenog koda, napravljen sa <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">ljubavlju</span> od strane Grokability, Inc.',
    'set_password' => 'Postavi lozinku',
    'upload_deleted' => 'Stavka je obrisana',
    'child_locations' => 'Podlokacije',
    'append' => 'Nadoveži',
    'optional' => 'OPCIONO',
    'audit_by_field' => 'Revizija po polju',
    'audit_by_field_help' => 'Revizija skeniranjem serijskih brojeva je jedina dostupna opcija ako je zahtevano da serijski brojevi budu jedinstveni u Administratorskim postavkama.',
    'checkin_by_field' => 'Razduži prema polju',
    'checkin_by_field_help' => 'Razduživanje skeniranjem serijskih brojeva je opcija dostupna samo ako je podešeno da serijski brojevi moraju biti jedinstveni u Administratorskim postavkama.',
    'audit_key' => 'Imovina',
    ...
    'bulk_delete_associations' => [
        ...
        'assoc_users_no_count' => ':item_name je trenutno povezan sa drugim korisnicima i ne može biti izbrisan. Molim vas ažurirajte vaše korisnike da više nisu povezani sa :item i pokušajte ponovo.',
        'assoc_child_companies_no_count' => ':item?name je trenutno roditelj drugim kompanijama i ne može biti izbrisana. Molim vas prerasporedite ili izbrišite kompanije naslednice pre ponovnog pokušaja.',
        'assoc_checkouts_no_count' => ':item_name je trenutno zaduženo. Molim vas razdužite sve stavke pre brisanja :item.',
    ],
