...
return [
    ...
    'backups_clean' => 'Maak de backed-up database schoon voor herstel',
    ...
    'load_remote' => 'Laad Externe Avatars',
    'load_remote_help_text' => 'Vink dit selectievakje uit als uw installatie geen scripts van het internet kan laden. Dit zal voorkomen dat Snipe-IT avatars van Gravatar of andere bronnen probeert te laden.',
    ...
    'webhook_help' => 'Integratie instellingen',
    'webhook_botname' => ':app Botnaam',
    'webhook_channel' => ':app Kanaal',
    'webhook_endpoint' => ':app Endpoint',
    'webhook_integration' => ':app Instellingen',
    'webhook_test' => 'Test :app integratie',
    ...
    'oauth_redirect_url' => 'Omleidings URL',
    'oauth_name_help' => ' Iets dat uw gebruikers herkennen en vertrouwen.',
    'oauth_scopes' => 'Scopes',
    ...
    'oauth_token_status_active' => 'Actief',
    'oauth_revoke' => 'Revoke',
    ...
    'label2_enable_help' => 'Schakel over naar de nieuwe labelmaker. <b>Opmerking: u moet deze instelling opslaan voordat u anderen kunt instellen.</b>',
    'label2_template' => 'Sjabloon',
    'label2_template_help' => 'Selecteer welke template gebruikt moet worden voor generatie van de labels',
    'label2_title' => 'Titel',
    'label2_title_help' => 'The title to show on labels that support it. <br>This will occupy the first Label Field row.',
    'label2_title_help_phold' => 'De placeholder <code>{COMPANY}</code> wordt vervangen door de bedrijfsnaam van asset&apos;',
    'label2_asset_logo' => 'Gebruik asset Logo',
    'label2_asset_logo_help' => 'Gebruik het logo van het aan asset&apos; toegewezen bedrijf, in plaats van de waarde bij <code>:setting_name</code>',
    ...
    'help_asterisk_bold' => 'Tekst ingevoerd als <code>**tekst**</code> wordt weergegeven als dikgedrukt',
    'help_blank_to_use' => 'Laat leeg om de waarde van <code>:setting_name</code> te gebruiken',
    ...
    'default' => 'Standaard',
    'none' => 'Geen',
    'google_callback_help' => 'Dit moet worden ingevoerd als de callback URL in je Google OAuth app instellingen in je organisatie&apos;s <strong><a href="https://console.cloud.google.com/" target="_blank">Google developer console <i class="fa fa-external-link" aria-hidden="true"></i></a></strong>.',
    'google_login' => 'Google Workspace login instellingen',
    'enable_google_login' => 'Activeer het inloggen voor gebruikers met Google Workspace',
    'enable_google_login_help' => 'Gebruikers zullen niet automatisch worden aangemaakt. Ze moeten hier een bestaand account hebben in Google Workspace, en hun gebruikersnaam moet overeenkomen met hun Google Workspace e-mailadres. ',
    'mail_reply_to' => 'Mail Reply-To Adres',
    'mail_from' => 'Mail Van Adres',
    ...
    'email_formats' => [
        ...
        'firstinitial_lastname' => 'Eerste initiaal Achternaam (j.smith@example.com)',
    ...
    'keywords' => [
        'brand' => 'voettekst, logo, print, thema, skin, header, kleuren, kleur, css',
        'general_settings' => 'bedrijfsondersteuning, handtekening, acceptantie, e-mailformaat, gebruikersnaam formaat, afbeeldingen, per pagina, thumbnail, eula, gravatar, tos, dashboard, privacy',
        'groups' => 'machtigingen, machtigingsgroepen, autorisatie',
        'labels' => 'labels, barcodes, barcode, sheets, print, upc, qr, 1d, 2d',
        'localization' => 'lokalisatie, valuta, lokaal, lokaal, tijdzone, tijdzone, internationaal, internatinalisatie, taal, vertaling',
        'php_overview' => 'phpinfo, systeem, info',
        'purge' => 'permanent verwijderen',
        'security' => 'wachtwoord, wachtwoorden, vereisten, twee factor, twee-factor, veelgebruikte wachtwoorden, externe login, logout, authenticatie',
