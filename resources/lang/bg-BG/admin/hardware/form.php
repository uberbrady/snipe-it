...
return [
    ...
    'serial_required_post_model_update' => ':asset_model беше настроен да изисква сериен номер. Моля добавете сериен номер за този актив.',
    'status' => 'Статус',
    ...
    'asset_not_deployable_checkin' => '{1} Този артикул има статус \'не може да бъде предоставен\'. Използвайки този статус ще впише обратно актива.|[2,*] Този артикул има статус \'не може да бъде предоставен\'. Използвайки този статус няма да промени нищо.',
    'asset_deployable' => '{1} Този артикул може да бъде изписан.|[2,*] Тези артикули могат да бъдат изписани.',
