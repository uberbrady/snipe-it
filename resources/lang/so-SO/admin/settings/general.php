...
return [
    ...
    'oauth_token_status_active' => 'Firfircoon',
    'oauth_revoke' => 'Revoke',
    ...
    'email_formats' => [
        ...
        'firstinitial_lastname' => 'Magaca Dambe ee Koowaad (j.smith@example.com)',
    ...
    'keywords' => [
        'brand' => 'cagta, astaanta, daabacaadda, mawduuca, maqaarka, madaxa, midabada, midabka, css',
        'general_settings' => 'taageerada shirkadda, saxeexa, aqbalaadda, qaabka iimaylka, qaabka adeegsadaha, sawirada, bog kasta, thumbnail, eula, gravatar, tos, dashboard, sir',
        'groups' => 'ogolaansho, kooxda ogolaanshah, wakiilasho',
        'labels' => 'labels, barcodes, barcode, sheets, print, upc, qr, 1d, 2d',
        'localization' => 'meeleyn, lacag, gudaha, goob, goobta waqtiga, waqtiga goobta, caalami, wareejin, luuqad, luuqado, tarjamo',
        'php_overview' => 'phpinfo, nidaamka, macluumaadka',
        'purge' => 'si joogto ah u tirtir',
        'security' => 'password, passwords, baahiyaha, labo factor, labo-factor, passwords guud, fogaan kasoo gelid, kabixid, ogolaansho',
