...
return [
    ...
    'bulk_update_with_custom_field' => '注意：資產共有 :asset_model_count 種不同的型號。',
    'bulk_update_model_prefix' => '依型號',
    'bulk_update_custom_field_unique' => '這是唯一欄位，無法進行批次編輯。',
    'checkedout_to' => '借出至',
    'checkout_date' => '借出日期',
    'checkin_date' => '繳回日期',
    'checkout_to' => '借出至',
    ...
    'redirect_to_all' => '返回所有 :type',
    'redirect_to_type' => '前往 :type',
    'redirect_to_checked_out_to' => '前往借出對象',
    'redirect_to_bulk_checkout' => 'Return to Bulk Checkout',
    'select_statustype' => '選擇狀態類型',
    'serial' => '序號',
    'serial_required' => '資產 :number 需要序號',
    'serial_required_post_model_update' => ':asset_model 已更新為需要序號。請為此資產新增序號。',
    'status' => '狀態',
    'tag' => '資產標籤',
    'update' => '更新資產',
    'warranty' => '保固',
    ...
    'asset_location_update_actual' => '只更新實際位置',
    'asset_not_deployable' => '該資產狀態無法部署。此資產無法被借出。',
    'asset_not_deployable_checkin' => '{1} 該資產狀態無法部署。使用此狀態標籤將繳回該資產。|[2,*] 該資產狀態無法部署。使用此狀態標籤不會有任何變更。',
    'asset_deployable' => '{1} 此資產可以被借出。|[2,*] 這些資產可以被借出。',
    'processing_spinner' => '處理中... (大型檔案可能需要一些時間)',
    'processing' => '處理中... ',
    'optional_infos' => '選填資訊',
    'order_details' => '訂單相關資訊',
    'calc_eol' => '若清除 EOL 日期，將依採購日期和 EOL 比率自動計算 EOL。',
    'checkin_licenses' => '繳回關聯的授權數量',
    'checkin_child_assets' => '繳回關聯的資產',
];
