...
return [
    ...
    'oauth_token_status_active' => 'Activ',
    'oauth_revoke' => 'Revoke',
    ...
    'email_formats' => [
        ...
        'firstinitial_lastname' => 'Primul nume inițial (j.smith@example.com)',
    ...
    'keywords' => [
        'brand' => 'footer, logo, print, temă, piele, antet, culori, culoare, css',
        'general_settings' => 'suport companie, signature, acceptance, e-mail format, nume de utilizator, imagini, per pagină, thumbnail, eula, gravatar, tos, dashboard, confidențialitate',
        'groups' => 'permisiuni, grupuri de permisiuni, autorizare',
        'labels' => 'labels, barcodes, barcode, sheets, print, upc, qr, 1d, 2d',
        'localization' => 'localizare, monedă, locală, zonă-orar, fus orar, internațional, internatinalizare, limbă, limbă, traducere',
        'php_overview' => 'phpinfo, sistem, info',
        'purge' => 'şterge permanent',
        'security' => 'parolă, parole, cerințe, doi factori, doi factori, parole comune, conectare la distanță, deconectare, autentificare',
