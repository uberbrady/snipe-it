...
return [
    ...
    'admin_cc_always' => 'Siempre envía copia al asignar/devolver.',
    'admin_cc_when_acceptance_required' => 'Solo enviar copia al asignar si se requiere aceptación',
    ...
    'alert_interval' => 'Umbral de alertas de caducidad',
    ...
    'audit_interval_help' => 'Si se le exige auditoría física regular de sus activos, ingrese el intervalo en meses que utilice. ',
    ...
    'backups_restore_warning' => 'Utilice el botón de restauración <small><span class="btn btn-xs btn-warning"><i class="text-white fa-solid fa-trash-arrow-up" aria-hidden="true"></i></span></small> para restaurar desde una copia de seguridad anterior. (Esto no funciona con almacenamiento de archivos S3).<br><br>Su <strong>base de datos completa de :app_name y cualquier archivo cargado será completamente reemplazado</strong> por lo que hay en la copia de seguridad.  ',
    ...
    'color_settings_help' => 'Estos ajustes se utilizarán a través de Snipe-IT. Los usuarios pueden anular los colores de los enlaces editando sus preferencias de cuenta para cumplir con sus requisitos individuales de legibilidad.',
    'color_reset' => 'Restablecer a valores por defecto',
    ...
    'acceptance_note' => 'Agrega una nota para tu decisión (obligatoria si se declina)',
    ...
    'footer_text_placeholder' => 'Texto opcional para el pie de página',
    ...
    'header_color' => 'Color de tema principal',
    'header_color_help' => 'Seleccionar un nuevo color aquí le permitirá previsualizar el color con su logo seleccionado (si tiene un logo subido) en el encabezado, Sin embargo, no se guardará hasta que haga clic en el botón Guardar.',
    'link_dark_color' => 'Color de enlace para modo obscuro',
    'nav_link_color' => 'Header Nav Link Color',
    'nav_link_color_help' => 'Seleccione un color para los enlaces en su navegación de nivel superior. Este color debe ser suficientemente alto en contraste con el color de la cabecera para ser fácilmente legible.',
    'link_dark_color_help' => 'Seleccione un color que proporcionará suficiente contraste para las personas que usan Snipe-IT en modo oscuro.',
    'link_light_color' => 'Color de enlace para modo Claro',
    'link_light_color_help' => 'Selecciona un color que proporcione suficiente contraste para las personas que utilicen Snipe-IT en modo Claro.',
    ...
    'ldap_wizard' => [
        ...
        'state_complete' => 'fecha de Terminación',
    ...
    'ldap_display_name_help' => 'Si tiene un campo displayName separado en su LDAP/AD, lo mapeará aquí y se utilizará para mostrar usuarios dentro de Snipe-IT.',
    ...
    'ldap_invert_active_flag_help' => 'Si está habilitado: cuando el valor devuelto por LDAP Active Flag es <code>0</code> o <code>false</code>, la cuenta de usuario estará activa.',
    ...
    'labels_title_help' => 'Los cambios realizados aquí deben guardarse antes de que se reflejen en las etiquetas o en la vista previa de abajo.',
    'labels_help' => 'Configuración de códigos de barras &amp; etiquetas',
    'purge_help' => 'Eliminar permanentemente los registros eliminados',
    ...
    'text' => 'Texto',
    'manager_view' => 'Vista de gerente',
    'manager_view_enabled_text' => 'Activar vista de supervisor',
    ...
    'username_formats' => [
        ...
        'firstname_lastname_underscore_format' => 'Nombre Apellido (jane_smith)',
        'firstinitial_lastname' => 'Inicial del nombre y apellido (j.smith)',
    ...
    'legends' => [
        'checkin' => 'Preferencias de entrega',
        ...
        'your_details' => 'Tu información',
        'server' => 'Configuraciones de servidor',
        'scoping' => 'Alcance',
        'security' => 'Preferencias de seguridad',
        'passwords' => 'Preferencias de seguridad de contraseña',
    ],
    ...
    'keywords' => [
        ...
        'notifications' => 'alertas, correo electrónico, notificaciones, auditoría, umbral, alertas de correo electrónico, cc',
