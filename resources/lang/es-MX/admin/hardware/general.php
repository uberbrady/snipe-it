...
return [
    ...
    'bulk_checkin' => 'Devolución masiva',
    ...
    'require_serial' => 'Requerir número de serie',
    'require_serial_help' => 'Se requerirá un número de serie al crear un nuevo activo de este modelo.',
